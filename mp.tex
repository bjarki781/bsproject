...
Given a family of equivalences $J$ its cluster generating function, and hence the generating
function that enumerates the equivalence classes $J$ induces, is completely determined by how
patterns in the equivalence cluster.
